...
type GreeterClient interface {
	...
	Curse(ctx context.Context, in *CurseRequest, opts ...grpc.CallOption) (*CurseReplay, error)
}
...
func (c *greeterClient) Curse(ctx context.Context, in *CurseRequest, opts ...grpc.CallOption) (*CurseReplay, error) {
	out := new(CurseReplay)
...
type GreeterServer interface {
	...
	Curse(context.Context, *CurseRequest) (*CurseReplay, error)
...
func (UnimplementedGreeterServer) Curse(context.Context, *CurseRequest) (*CurseReplay, error) {
